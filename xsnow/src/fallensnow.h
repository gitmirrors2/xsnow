...
extern void   DrawFallen(FallenSnow *fsnow, int dropblobtime);
extern void   GenerateFlakesFromFallen(FallenSnow *fsnow, int x, int w, float vy, float amount, int accum);
